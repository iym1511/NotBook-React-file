...
const Profile = ({productLists, onRemove}) => {
    ...
    function up() {
        ...
        console.log(state.user.likelist[0])
    }
        ...
        <div>
            <Container>
                ...
                <div style={{width:"350px", height:"200px", border:"1px solid white",margin:"20px auto"}}></div>}
                    ...
                    <Col>
                    <p style={{fontSize:"20px", fontWeight:"bold"}}>시승 신청 예약</p>
                        ...
                        state.user.likelist.map((like)=>(<li className="like-name" >
                            <div className="product-list">
                                ...
                                <span className="updown-All">
                                    ...
                                    <span style={{fontSize:"15px", fontWeight:"bold"}}>시승 신청 예약</span>
                                    <span><DatePicker selected={startDate} onChange={date => setStartDate(date)} style={{border:"1px solid white", borderRadius:"10px",display:"inline"}}/></span>
